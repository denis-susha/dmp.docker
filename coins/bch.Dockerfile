# BCH daemon for Bitcart, based on the upstream bitcart-docker template for Bitcart 0.9.0.0.
...
RUN apk add git gcc python3-dev musl-dev automake autoconf libtool file make libffi-dev openssl-dev rust cargo && \
